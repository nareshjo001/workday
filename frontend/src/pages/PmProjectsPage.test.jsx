...
const controlWithFinding = (id, name) => ({ project: { id, name, status: "ACTIVE" }, summary: { attention_count: 1, by_severity: { HIGH: 0, MEDIUM: 0, LOW: 0, INFO: 1 } }, findings: [{ code: "OPEN_REQUIREMENTS_REMAIN", severity: "INFO", title: `${name} staffing`, summary: "One role remains.", evidence: [{ key: "remaining", label: "Remaining roles", value: 1 }], recommended_action: "Review requirements.", source: { engine: "pm_project_control", version: "1" } }] });
