 ...
 * components/projects/ProjectCardList, and shared between PM review mode
 * and Vendor read-only history the same way InvoiceTable is — see that
 * component's own comment for the isReviewMode rationale.
 */
        ...
        return (
          <div key={inv.id} className="rounded-md border border-border bg-surface p-4">
            <div className="flex items-start justify-between gap-3">
              ...
              {!isReviewMode && <InvoiceStatusBadge status={inv.status} />}
            </div>
